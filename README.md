...
Pre-requisites: Docker and a web browser. Note: if you run a Windows PC, I suggest you install VirtualBox on it, then create a Linux VM inside VirtualBox, and run the Docker steps from there.
